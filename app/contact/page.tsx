...
const options = ["Personal or family matter", "Business or commercial matter", "Criminal defence or bail", "Estate, will or legacy planning", "Claim, dispute or deadline", "General enquiry"];

const matterRoutes = [
  ["Family & personal", "Divorce, maintenance, parenting arrangements and sensitive family transitions."],
  ["Business & commercial", "Contracts, company advice, negotiations, risk and commercial disputes."],
  ["Criminal defence", "Urgent bail assistance, criminal procedure and considered defence strategy."],
  ["Estates & wills", "Wills, estate planning, deceased estates and protecting what matters."],
  ["Litigation & claims", "Civil disputes, state claims, demand letters and court-directed strategy."],
  ["Not sure where it fits?", "Start with the facts. The firm will help identify the right legal starting point."],
];
...
export default function ContactPage() {
  ...
  return (
    <main className="editorial-page contact-page">
      <header className="editorial-header"><a href="/" className="editorial-brand editorial-brand-logo"><img src="https://im-attorneys.gee7pipz.chatgpt.site/assets/im-attorneys-incorporated-logo.webp" alt="Ingrid Mtsweni Attorneys Incorporated" width={1200} height={400} /></a><nav><a href="/#expertise">Practice areas</a><a href="/about">About the firm</a><a className="editorial-header-cta" href="tel:+27812488048">Call 081 248 8048</a></nav></header>
      ...
      <section className="contact-matters"><div className="editorial-section-heading"><span>Where we can begin</span><h2>Your concern deserves the right first conversation.</h2><p>Choose the closest description below or simply send a general enquiry. You do not need to diagnose the legal issue yourself before contacting the firm.</p></div><div className="contact-matter-grid">{matterRoutes.map(([title, copy], index) => <article key={title}><small>0{index + 1}</small><h3>{title}</h3><p>{copy}</p></article>)}</div></section>
      ...
      <section className="contact-prepare">
        <div><span className="editorial-kicker">Prepare without pressure</span><h2>Bring what you have. We will help organise what matters.</h2><p>If available, keep relevant notices, agreements, court documents, messages and important dates nearby. Do not delay an urgent enquiry because your file is incomplete.</p></div>
        <div className="contact-prepare-list"><article><small>01</small><strong>The essential timeline</strong><p>What happened, when it happened and whether a deadline or court date is approaching.</p></article><article><small>02</small><strong>The documents you received</strong><p>Bring originals or clear copies. Avoid sending sensitive documents through unsecured channels unless requested.</p></article><article><small>03</small><strong>Your preferred outcome</strong><p>Tell us what you want to protect, resolve or understand—even if you are uncertain what is legally possible.</p></article></div>
        <aside><strong>Confidentiality begins with careful communication.</strong><p>Share only the essentials in your first online message. The firm can advise on a secure way to provide detailed or sensitive records.</p><a href="mailto:attorneys@iminc.co.za">Email the firm <b>→</b></a></aside>
      </section>
      <footer className="editorial-footer"><a href="/" className="editorial-footer-logo"><img src="https://im-attorneys.gee7pipz.chatgpt.site/assets/im-attorneys-incorporated-logo.webp" alt="Ingrid Mtsweni Attorneys Incorporated" width={1200} height={400} /></a><span>Menlyn Maine · Pretoria · South Africa</span><a href="/insights">Read our insights</a></footer>
    </main>
  );
}
